...
describe('command', () => {
    ...
    it('should pass', () => {
        ...
        return expect(boundMatchImageSnapshot(subject, commandOptions)).resolves.not.toThrow();
    });
    ...
    it('should fail', () => {
        ...
        expect.assertions(1);
        return expect(boundMatchImageSnapshot(subject, commandOptions)).rejects.toThrowErrorMatchingSnapshot();
    });
